...
public class EmpController {
    ...
    public List<Employee> searchEmployees(@RequestParam String keyword) {
        return employeeSerivce.searchEmployees(keyword);
    }

    @GetMapping("employees/filter/name")
    public List<Employee> filterByName(@RequestParam String name) {
        return employeeSerivce.filterByName(name);
    }

    @GetMapping("employees/filter/email")
    public List<Employee> filterByEmail(@RequestParam String email) {
        return employeeSerivce.filterByEmail(email);
    }

    @GetMapping("employees/filter/phone")
    public List<Employee> filterByPhone(@RequestParam String phone) {
        return employeeSerivce.filterByPhone(phone);
    }
